...
host="hotfix2.stage.screening.navify.com"
domain=""
version="/api/v1/"
auth_token_endpoint="/auth/realms/cxca-cockpit/protocol/openid-connect/token"
patient_id="c2208c90-9753-45c3-95d3-70839916c9f0"
max_time=150
dns_resolver=""

idp_client_secret='U*36kx9jvH8:U#Eta(![Bu&ZG(Hl5N${'
#idp_username='devops'
idp_username='testuser2'
  ...
  case $opt in
    e)
      if [ "$OPTARG" == "cloudflare" ]; then
				...
				dns_resolver=""
				json_data='{
          "patientId": "c2208c90-9753-45c3-95d3-70839916c9f0",
          "immunosuppressed": {
            "value": "no",
          ...
          "others": "a detailed comment"
				...
				domain="https://$host"
				dns_resolver=" --resolve $host:443:3.78.211.29" #3.65.242.198 #3.73.165.110
				echo "************************************************************************"
