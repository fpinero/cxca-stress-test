...
host="hotfix3.stage.screening.navify.com"
domain=""
version="/api/v1/"
auth_token_endpoint="/auth/realms/cxca-cockpit/protocol/openid-connect/token"
patient_id="0eae9778-b301-4a22-89ad-62bf3f76fc0d"
max_time=150
dns_resolver=""

idp_client_secret='x=2%oq:0$q}>80%o&$++Wu7uj}p%ZJp3'
#idp_username='devops'
  ...
  case $opt in
    e)
      if [ "$OPTARG" == "cloudflare" ]; then
				...
				dns_resolver=""
				json_data='{
          "patientId": "0eae9778-b301-4a22-89ad-62bf3f76fc0d",
          "immunosuppressed": {
            "value": "no",
          ...
          "others": "a detailed comment"
				...
				domain="https://$host"
				dns_resolver=" --resolve $host:443:3.65.123.61" #3.65.242.198 #3.73.165.110
				echo "************************************************************************"
